...
namespace hpl {
  ...
  class cCharacterBodyCollideStepUp : public iPhysicsWorldCollisionCallback
  {
  public:
    cCharacterBodyCollideStepUp();
    ...
    void SetCollidePlayer(bool abX);
    bool GetCollidePlayer() { return mbCollidePlayer; }
    ...
    cCharacterBodyCollideStepUp *mpCollideCallbackStepUp;
