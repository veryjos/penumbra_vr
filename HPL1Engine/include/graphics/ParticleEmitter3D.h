...
namespace hpl {
	...
	{
		kSaveData_ClassInit(iParticleEmitter3D)
	public:
		tString msDataName;
	...
	public:
		...
		void UpdateGraphics(cCamera3D *apCamera,float afFrameTime, cRenderList *apRenderList, bool dontUpdateLast=false);
