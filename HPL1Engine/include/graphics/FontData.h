...
namespace hpl {
    ...
    * \param ...
    */
    void DrawImmediate(const cVector3f& avPos, const cVector2f& avSize, const cColor& aCol, eFontAlign mAlign,
      const wchar_t* fmt, ...);
    ...
    /**
    * Draw a string with word wrap in world space.
    * \param avPos Screen pos
    * \param afLength Max length of a line
    * \param afFontHeight The distance from base of character above to base of character below
    * \param avSize size of the characters
    ...
    * \return Extra number of rows generated.
    */
    int DrawWordWrapWorld(cVector3f avPos, float afLength, float afFontHeight, cVector2f avSize, const cColor& aCol,
