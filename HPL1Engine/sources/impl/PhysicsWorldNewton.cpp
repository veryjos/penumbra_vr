...
namespace hpl {
  ...
  bool cPhysicsWorldNewton::CheckShapeWorldSweep(cVector3f *apNewPos,
    iCollideShape* apShape, const cMatrixf& a_mtxTransform,
    const cMatrixf& b_mtxTransform,
    iPhysicsBody *apSkipBody, bool abSkipStatic,
    bool abIsCharacter,
    iPhysicsWorldCollisionCallback *apCallback,
    bool abCollideCharacter,
    bool abDebug,
    bool abCollidePlayer,
    bool abIsPlayer)
  {
    return false;
  }
