...
static eMainMenuState gvMenuBackStates[] = {
		...
		eMainMenuState_Start,//eMainMenuState_VRTutorial,
...
cMainMenuWidget_VRTutorial::cMainMenuWidget_VRTutorial(cInit *apInit, const cVector3f &avPos,
...
cMainMenuWidget_VRTutorial::~cMainMenuWidget_VRTutorial()
{

}

void cMainMenuWidget_VRTutorial::OnUpdate(float afTimeStep)
{
  mfOverTimer += afTimeStep*1.3f;
...
void cMainMenuWidget_VRTutorial::OnMouseOver(bool abOver)
{
  mbOver = abOver;
...
void cMainMenuWidget_VRTutorial::OnDraw()
{
  mpFont->Draw(mvPositon, mvFontSize, cColor(0.62f + mfAlpha*0.3f, 1), eFontAlign_Center, msText.c_str());
...
{
public:
  cMainMenuWidget_UseTrackpadMovement(cInit *apInit, const cVector3f &avPos, const tWString& asText, cVector2f avFontSize, eFontAlign aAlignment)
    : cMainMenuWidget_Button(apInit, avPos, asText, eMainMenuState_LastEnum, avFontSize, aAlignment)
  {
  }
  ...
  void OnMouseDown(eMButton aButton)
  {
    mpInit->mpButtonHandler->mbUseTrackpadMovement = !mpInit->mpButtonHandler->mbUseTrackpadMovement;
    gpUseTrackpadMovementText->msText = mpInit->mpButtonHandler->mbUseTrackpadMovement ? kTranslate("MainMenu", "On") :
...
class cMainMenuWidget_RenderToMonitor : public cMainMenuWidget_Button
{
public:
  cMainMenuWidget_RenderToMonitor(cInit *apInit, const cVector3f &avPos, const tWString& asText, cVector2f avFontSize, eFontAlign aAlignment)
    : cMainMenuWidget_Button(apInit, avPos, asText, eMainMenuState_LastEnum, avFontSize, aAlignment)
  {
  }
