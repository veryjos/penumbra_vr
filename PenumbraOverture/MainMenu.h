...
enum eMainMenuState
{
  ...
  eMainMenuState_OptionsVRSettings,
...
class cMainMenuWidget_VRTutorial : public cMainMenuWidget
{
public:
  cMainMenuWidget_VRTutorial(cInit *apInit, const cVector3f &avPos, const tWString& asText);
  ~cMainMenuWidget_VRTutorial();
