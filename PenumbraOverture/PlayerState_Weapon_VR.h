 ...
 */
#ifndef GAME_PLAYER_STATE_WEAPON_VR_H
#define GAME_PLAYER_STATE_WEAPON_VR_H
...
class cPlayerState_Throw_VR : public iPlayerState
{
public:
	cPlayerState_Throw_VR(cInit *apInit,cPlayer *apPlayer);
...
class cPlayerState_WeaponMelee_VR : public iPlayerState
{
public:
	
	cPlayerState_WeaponMelee_VR(cInit *apInit,cPlayer *apPlayer);
