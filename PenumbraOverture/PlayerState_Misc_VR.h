...
class cPlayerState_InteractMode_VR : public iPlayerState
{
public:
  cPlayerState_InteractMode_VR(cInit *apInit, cPlayer *apPlayer);
...
class cPlayerState_UseItem_VR : public iPlayerState
{
private:
  ePlayerMoveState mPrevMoveState;
...
public:
  cPlayerState_UseItem_VR(cInit *apInit, cPlayer *apPlayer);
  ...
  cVector3f mvUseLineStart;
  cVector3f mvUseLineEnd;
};
...
class cPlayerState_Message_VR : public iPlayerState
{
private:
  ePlayerMoveState mPrevMoveState;
  ePlayerState mPrevState;
...
public:
  ...
  cPlayerState_Message_VR(cInit *apInit, cPlayer *apPlayer);
...
//////////////////////////////////////////////////////////////////////////
class cGameLadder;
class cPlayerState_Climb_VR : public iPlayerState
{
private:
  int mlState;
  ...
  void OnPostSceneDraw();
public:
  cPlayerState_Climb_VR(cInit *apInit, cPlayer *apPlayer);
  ...
  int ladderSoundsLeft;
  float ladderSoundCount;
