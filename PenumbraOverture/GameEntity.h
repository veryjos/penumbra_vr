...
public:
  ...
  virtual eCrossHairState GetCompletePickCrosshairState(iPhysicsBody *apBody);
	virtual eCrossHairState GetPickCrossHairState(iPhysicsBody *apBody, bool noInteract=false);
  virtual eCrossHairState GetPickHandState(iPhysicsBody *apBody);
