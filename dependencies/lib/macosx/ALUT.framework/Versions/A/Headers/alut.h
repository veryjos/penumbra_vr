...
#define alutInit _alutInit
#define alutExit _alutExit
#define alutLoadWAVFile _alutLoadWAVFile
#define alutLoadWAVFileMemory _alutLoadWAVFileMemory
#define alutUnloadWAV _alutUnloadWAV
...
ALUT_API ALboolean ALUT_APIENTRY _alutInit (int *argcp, char **argv);
ALUT_API ALboolean ALUT_APIENTRY alutInitWithoutContext (int *argcp, char **argv);
ALUT_API ALboolean ALUT_APIENTRY _alutExit (void);
...
ALUT_API ALUT_ATTRIBUTE_DEPRECATED void ALUT_APIENTRY _alutLoadWAVFile (ALbyte *fileName, ALenum *format, void **data, ALsizei *size, ALsizei *frequency);
ALUT_API ALUT_ATTRIBUTE_DEPRECATED void ALUT_APIENTRY _alutLoadWAVMemory (ALbyte *buffer, ALenum *format, void **data, ALsizei *size, ALsizei *frequency);
#else
...
#endif
ALUT_API ALUT_ATTRIBUTE_DEPRECATED void ALUT_APIENTRY _alutUnloadWAV (ALenum format, ALvoid *data, ALsizei size, ALsizei frequency);
